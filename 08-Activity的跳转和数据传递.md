...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //获取文本组件
        Intent text_intent = getIntent();
        String text_user_message  = text_intent.getStringExtra("user_message");
        user_message = findViewById(R.id.textFromUserActivity);
        if (text_user_message!=null){
            user_message.setText(text_user_message);
        }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn_back.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                intent.putExtra("user_message","我是来自user_activity的内容");
                startActivity(intent);
            }
        });
    }
